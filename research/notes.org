...
** TODO adding suspendable syscall
...
** TODO we should remove all direct trio stuff from code which is called by suspendables
...
** TODO support futures so we can do pipelined ordered syscalls
   so so so.
...
*** TODO converted everything, time to deal with issues
...
*** TODO should i remove the trio runner from delegators on cancel?
    probs right?
...
** TODO implement trio-compatible shift/reset
...
*** TODO handling shift hmmm
    ...
    yeah sure, why not
*** TODO shutdown of reset coroutines
