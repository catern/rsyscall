...
** TODO remove syscall eof message
   Hmm, what's the clean way to shut down a thread?
   Exit it?
** TODO stop using noplt?
* deployment
...
** TODO get working on Debian
*** TODO make Nix deps optional
    So, hm. HmMmMm.
...
** TODO stop using python O flags and EPOLL flags
