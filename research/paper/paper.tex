...
but instead is sent to some other process to be evaluated,
and the results received from that process.
...
Our current implementation of \texttt{rsyscall} is focused on supporting Python,
