...
\item
  ...
  have acceptable overhead relative to the alternatives?
...
A given component can be implemented with a separate process which has the file descriptor passed down,
