...
Processes are created running a stub function which, in an infinite loop,
...
*** portability?
we don't think portability concerns should prevent moving unix-like systems forward.
** conclusion
* Footnotes
