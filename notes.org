...
** make "local" module which has all the local things in it
** keeping nix store reference around
   ...
   blaaaaaaaaaargh
** TODO port ssh to not use executables from stdtask
...
*** TODO add interfaces for making ssh_hosts and things directly from store
