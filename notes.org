...
** getting rid of processresources
   ...
   we can move all the memory stuff into a memory subdir
*** memory rework
...
** fix memory allocator to save arenas!!
...
** switch everything over to the new epoll style
...
** use WrittenPointer[Sockbuf[Address]] to make accept/getname/etc calls nicer
