...
>>> ast.parse('async def dummy(): pass; dummy', '<unknown>', 'single')
Traceback (most recent call last):
  File "<stdin>", line 1, in <module>
  File "/nix/store/yxiqcxi4ml1k7v7yxsfcwarji2w551bc-python3-3.7.1/lib/python3.7/ast.py", line 35, in parse
    return compile(source, filename, mode, PyCF_ONLY_AST)
  File "<unknown>", line 1
    async def dummy(): pass; dummy
                                 ^
SyntaxError: unexpected EOF while parsing
>>> ast.parse('async def dummy(): pass', '<unknown>', 'single')
Traceback (most recent call last):
  File "<stdin>", line 1, in <module>
  File "/nix/store/yxiqcxi4ml1k7v7yxsfcwarji2w551bc-python3-3.7.1/lib/python3.7/ast.py", line 35, in parse
    return compile(source, filename, mode, PyCF_ONLY_AST)
  File "<unknown>", line 1
    async def dummy(): pass
                          ^
SyntaxError: unexpected EOF while parsing
>>> ast.parse('async def dummy(): pass', '<unknown>')
<_ast.Module object at 0x7f43071d9588>
>>> compile(ast.parse('async def dummy(): pass', '<unknown>'))
Traceback (most recent call last):
  File "<stdin>", line 1, in <module>
TypeError: compile() missing required argument 'filename' (pos 2)
>>> compile(ast.parse('async def dummy(): pass', '<unknown>'), '<string>')
Traceback (most recent call last):
  File "<stdin>", line 1, in <module>
TypeError: compile() missing required argument 'mode' (pos 3)
>>> compile(ast.parse('async def dummy(): pass', '<unknown>'), '<string>', 'exec')
<code object <module> at 0x7f430792ff60, file "<string>", line 1>
>>> eval(compile(ast.parse('async def dummy(): pass', '<unknown>'), '<string>', 'exec'))
>>> eval(compile(ast.parse('async def dummy(): pass; dummy', '<unknown>'), '<string>', 'exec'))
>>> eval(compile(ast.parse('async def dummy(): pass; return dummy', '<unknown>'), '<string>', 'exec'))
>>> return 3
  File "<stdin>", line 1
SyntaxError: 'return' outside function
>>> eval(compile(ast.parse('async def dummy(): pass\nreturn dummy', '<unknown>'), '<string>', 'exec'))
Traceback (most recent call last):
  File "<stdin>", line 1, in <module>
  File "<string>", line 2
SyntaxError: 'return' outside function
>>> eval(compile(ast.parse('async def dummy(): pass\ndummy', '<unknown>'), '<string>', 'exec'))
>>> eval(compile(ast.parse('async def dummy(): pass\n\ndummy', '<unknown>'), '<string>', 'exec'))
>>> eval(compile(ast.parse('async def dummy(): pass\n\n\ndummy', '<unknown>'), '<string>', 'exec'))
>>> exec(compile('1', 's', 'eval'))
>>> eval(compile('1', 's', 'eval'))
1
>>> eval(compile('1', 's', 'exec'))
>>> exec(compile('1', 's', 'exec'))
>>> locals()
{'__name__': '__main__', '__doc__': None, '__package__': None, '__loader__': <class '_frozen_importlib.BuiltinImporter'>, '__spec__': None, '__annotations__': {}, '__builtins__': <module 'builtins' (built-in)>, 'ast': <module 'ast' from '/nix/store/yxiqcxi4ml1k7v7yxsfcwarji2w551bc-python3-3.7.1/lib/python3.7/ast.py'>, 'dummy': <function dummy at 0x7f4306b1b0d0>}
>>> 
