...
** decide what to do with our two Paths
...
** TODO figure out good name for application scripts
...
** make SockaddrUn.from_path take a ramthread
...
** make mkdtemp a method on tmpdir
...
** thought
   ...
   Meh, anyway.
** change AFD methods to take pointers in their short form
