...
** finish refactoring to thread
** fix up rsysapps
** move out repl to separate package
* DOCUMENTATION!
  Time to write it!
** wait actually no
...
** split
   ...
   The single-threaded tutorial explains how to do things
   ...
   The multi-threaded tutorial explains the interface to creating and using multiple threads,
