...
** TODO delete is_reaper from monitor
** TODO track process groups
...
** TODO store childprocess in childthread
   one real use case: sending signals to trigger EINTR
   (to cancel syscalls)
** TODO switch from Signals to SIG
