...
** TODO getting rid of processresources
...
** more mixingification of handle.Task
...
** TODO move application scripts out of rsyscall module
   what should I call that directory?
** TODO rename StandardTask/RsyscallThread to Thread/ChildThread
...
** clean up do_unshare implementation
...
*** DONE start cleanup
    ...
    that seems wise.
*** cleaned part up, now for do_cloexec_except
...
** syscall connection rework for more batching
*** debugging
...
** clean up handling of unshare for connection
** clean creation and inheritance for connection
