...
As mentioned in the "kiselio" module docstring, check out this tutorial if you
...
from kiselio.outcome import Outcome
...
"A coroutine which yields Shift. Basically, a 'native' kiselio coroutine"
...
class TrioSystemWaitReadable:
    ...
    of implicit, untyped inheritance is against the core idea of kiselio anyway;
